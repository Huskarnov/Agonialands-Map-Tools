const metals = [
    [[0],[279,307],[269,277],[231,166],[203,269],[190,138],[252,259],[246,144]],
    [[0],[179,191],[285,340],[245,217],[251,142],[211,201],[251,280],[237,248],[306,199],[306,184]],
    [[0],[185,229],[203,203],[279,304],[233,217],[252,206]],
    [[0]],
    [[0],[289,177],[290,177],[290,176],[291,176],
...
const quests = [
    [[70],[307,188],[313,186],[305,177],[288,192],[303,191],[312,180]],
    [[100],[307,188],[294,193],[297,198],[277,201],[282,205],[290,212]],
    [[150],[307,188],[274,198],[282,168],[283,210],[250,197],[284,227]],
    [[200],[307,188],[208,103],[267,209],[263,245],[307,233],[278,287],[274,169]],
    [[300],[307,188],[273,194],[284,232],[260,168],[282,306],[245,255],[183,102]],
    [[375],[307,188],[247,167],[238,199],[314,215],[262,283],[213,188],[261,146],[217,92]],
    [[450],[307,188],[212,171],[194,93],[236,151],[222,265],[231,288]],
    [[525],[307,188],[204,207],[211,120],[249,285],[211,220]],
    [[600],[307,188],[245,132],[215,189],[190,194],[204,161]],

    [[70],[297,227]],
    [[175],[307,188],[238, 206]],
    [[200],[297,227]],
    [[250],[307,188],[211,98]],
    [[300],[266, 192],[212,191],[185,129],[186,284]],
    [[350],[266, 192],[229,180],[236,170]],
    [[375],[266, 192],[262,274],[252,290]],
    [[400],[238, 206],[264, 325],[175,137]],
    [[400],[169,329]],
    [[420],[275, 220],[294,220]]
...
const buttonsEvents = function(data, buttonWrapper){
    for (let g = 0; g <= buttonWrapper.children.length - 1; g++){
        ...
        buttonWrapper.children[g].addEventListener('click', (event) => {
            ...
            for( let y = data[g].length - 1; y >=1; y--){
