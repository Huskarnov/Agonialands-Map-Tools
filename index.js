...
const findTileButton = document.querySelector(
  '.lowBarSection:nth-child(3) button'
);
...
const questButtonsWrapper = document.querySelector(
  '.lowBarSection:nth-child(1) div'
);
const metalButtonsWrapper = document.querySelector(
  '.lowBarSection:nth-child(2) div'
);
...
const lowBarSection4Quests = document.querySelector(
  '.lowBarChoice button:nth-child(1)'
);
const lowBarSection4Metals = document.querySelector(
  '.lowBarChoice button:nth-child(2)'
);
const lowBarSection4TileFinder = document.querySelector(
  '.lowBarChoice button:nth-child(3)'
);
